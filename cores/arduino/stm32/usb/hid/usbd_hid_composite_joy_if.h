...
#ifndef __USBD_HID_COMPOSITE_JOY_IF_H
#define __USBD_HID_COMPOSITE_JOY_IF_H
#ifdef USBCON
...
/* Exported macro ------------------------------------------------------------*/
#define IS_HID_INTERFACE(DEVICE)    (((DEVICE) == HID_JOYSTICK) )
...
#endif /* __USBD_HID_COMPOSITE_JOY_IF_H */
